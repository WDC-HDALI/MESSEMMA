report 50019 "WDC Standerd Box Label"
{
    CaptionML = ENU = 'Standerd Box Label', FRA = 'Étiquette standard  de carton';
    RDLCLayout = './.vscode/src_Messem/Report/RDLC/StanderdBoxLabel.rdlc';
    DefaultLayout = RDLC;
    ApplicationArea = all;
    dataset
    {
