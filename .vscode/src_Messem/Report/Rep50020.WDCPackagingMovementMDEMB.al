report 50020 "WDC Packaging Movement MD/EMB"
{
    DefaultLayout = RDLC;
    RDLCLayout = './.vscode/src_Messem/Report/RDLC/PackagingMovementMDEMB.rdlc';

    CaptionML = ENU = 'Packaging Movement MD/EMB', FRA = 'Mouvement MD/EMB';
    ...
    var
        ...
        InventoryMovementCaptionLbl: TextConst ENU = 'Mouvement MD/EMB', FRA = 'Mouvement MD/EMB', NLD = 'Mouvement MD/EMB';
        PageCaptionLbl: TextConst ENU = 'page', FRA = 'page', NLD = 'Pagina';
        ActivityTypeCaptionLbl: TextConst ENU = 'Activity Type', FRA = 'Type activité', NLD = 'Activiteitssoort';
        PostingDateCaptionLbl: TextConst ENU = 'Posting Date', FRA = 'Date comptabilistion', NLD = 'Boekingsdatum';
