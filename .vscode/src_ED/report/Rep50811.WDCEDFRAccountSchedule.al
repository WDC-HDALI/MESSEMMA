report 50811 "WDC-ED FR Account Schedule"
{
    DefaultLayout = RDLC;
    RDLCLayout = './.vscode/src_ED/report/RDLC/FRAccountSchedule.rdlc';
    captionML = ENU = 'FR Account Schedule', FRA = 'Tableau analyse Bilan/Résultat';
    UsageCategory = ReportsAndAnalysis;

    dataset
    {
        dataitem("FR Acc. Schedule Name"; "WDC-ED FR Acc. Schedule Name")
        {
            ...
            dataitem("FR Acc. Schedule Line"; "WDC-ED FR Acc. Schedule Line")
            {
    ...
    local procedure CalcSchedLineTotal(AccSchedLine2: Record "WDC-ED FR Acc. Schedule Line"; Level: Integer; var TotalNetChange: Decimal; var TotalNetChange2: Decimal): Boolean
    var
    ...
    procedure CalcSchedLineDebitCredit(var GLAcc3: Record "G/L Account"; AccSchedLine2: Record "WDC-ED FR Acc. Schedule Line"; var TotalAmount: Decimal)
    begin
    ...
    var
        ...
        Text10801: TextConst ENU = 'Period: ',
                             FRA = 'Période : ';
        Account_ScheduleCaptionLbl: TextConst ENU = 'Account Schedule',
                                              FRA = 'Tableau d''analyse';
        CurrReport_PAGENOCaptionLbl: TextConst ENU = 'Page',
                                               FRA = 'Page';
        FR_Acc__Schedule_Name__NameCaptionLbl: TextConst ENU = 'FR Acc. Schedule Name',
                                                         FRA = 'Nom tableau d''analyse B/R';
        Previous_Period_Control23CaptionLbl: TextConst ENU = 'Realized (%)',
                                                       FRA = 'Réalisé (%)';
        Comptes_NCaptionLbl: TextConst ENU = 'Comptes N',
                                       FRA = 'Comptes N';
}
