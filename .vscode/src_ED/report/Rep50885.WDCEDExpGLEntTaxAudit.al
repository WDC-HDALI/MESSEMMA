report 50885 "WDC-ED Exp G/L Ent. Tax Audit"
{
    ApplicationArea = All;
    captionML = ENU = 'Export G/L Entries - Tax Audit', FRA = 'Exporter écritures comptables - Audit fiscal';
    ProcessingOnly = true;
    ...
    var
        ...
        MissingStartingDateErr: TextConst ENU = 'You must enter a Starting Date.';
        MissingEndingDateErr: TextConst ENU = 'You must enter an Ending Date.';
        NoEntriestoExportErr: TextConst ENU = 'There are no entries to export within the defined filter. The file was not created.';
        InvalidWindowsChrStringTxt: TextConst ENU = '""#%&*:<>?\/{|}~';
        ServerFileExtensionTxt: TextConst ENU = 'TXT';
    ...
    var
        ...
        DateApplied: Date;
    begin
        if (GLEntry."Transaction No." <> CurrentTransactionNo) or (GLEntry."Source Type".AsInteger() <> CurrentSourceType) then begin
            ...
            CurrentSourceType := GLEntry."Source Type".AsInteger();
        end;
